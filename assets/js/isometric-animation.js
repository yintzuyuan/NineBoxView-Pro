...
(function () {
  ...
  const textPools = {
    // 繁體中文：傳統漢字
    'zh-Hant': {
      reference: ['酬', '鷹', '靈', '南', '去', '經', '三', '來', '過', '五', '湖', '愛', '鬱', '袋'],
      locked: ['東', '今', '國', '我', '上', '下'],
      center: '永'
    },
    // 簡體中文
    'zh-Hans': {
      reference: ['天', '地', '玄', '黄', '宇', '宙', '洪', '荒', '日', '月','盈', '昃', '辰', '宿', '列', '张'],
      locked: ['鑫', '龙', '国', '今', '我', '中'],
      center: '永'
    },
    // 日文
    'ja': {
      reference: ['い', 'う', 'え', 'お', 'か', 'き', 'く', 'さ', 'し', 'す', 'せ', 'た', 'な', 'は', 'ま'],
      locked: ['ア', 'イ', 'ウ', 'エ', 'オ', 'カ', 'キ', 'ク', 'ケ', 'コ'],
      center: 'あ'
    },
    // 韓文
    'ko': {
      reference: ['가', '나', '다', '라', '마', '바', '사', '아', '자', '차', '카', '타', '파', '하'],
      locked: ['글', '힘', '빛', '꿈', '별', '달', '숲', '봄', '꽃'],
      center: '한'
    }
  };
